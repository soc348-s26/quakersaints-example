...
One idea that is
explored is whether stories that are labelled as appropriate for younger
children. For this purpose the original, unstemmed words are used, but 
with punctuation removed and all letters set to lower case.
...
```{r fig.width = 7}
ggplot(qs_nrc, aes(x = title, color = sentiment, fill = sentiment))  +
  geom_bar() +
  coord_flip() +
 ...
 theme( axis.text.y = element_text(size = 5),
  ...
  labs(title = "Figure 5: Distribution of NRC Sentiments",
       subtitle = "By whether the book is recommended for younger readers") +
  scale_fill_brewer(palette = "Set1") +
  scale_color_brewer(palette = "Set1")
...
test indicates that the two variables are not independent. The children's
stories are much more likely to have the emotions of fear, joy and trust than the other stuories. (X-squared = 20.885, df = 7, p-value = 0.003944)
